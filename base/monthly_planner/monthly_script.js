...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🌟 daily_script.js와 동일한 6색 순환(month % 6)으로 맞춤 - 같은 달이면 daily/monthly 테마 색이 일치해야 함
    ...
    // 🌟 월과 무관하게 항상 같은 개수인 정적 반복 요소(목표란 구분선 3줄, 투두 17줄)는
    // HTML에 나열하지 않고 여기서 한 번만 생성한다
    fillRepeatedRows(document.querySelector('.monthly-goal-body'), 3, 'quote-row');
    fillRepeatedRows(document.querySelector('.todo-rows'), 17, 'todo-row');
